...
for j=1:size(data,4)
    sig_g(:,j)=interp3(linspace(1,size(data,2),size(data,2)),linspace(1,size(data,1),size(data,1)),linspace(1,size(data,3),size(data,3)),squeeze(data(:,:,:,j)),g2,g1,g3);
    sig_w(:,j)=interp3(linspace(1,size(data,2),size(data,2)),linspace(1,size(data,1),size(data,1)),linspace(1,size(data,3),size(data,3)),squeeze(data(:,:,:,j)),w2,w1,w3);
end
